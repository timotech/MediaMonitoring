    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToAction("Dashboard", "Electronic");
                    }

                    //if(model.ReturnUrl == "Outdoor")
                    //{
                    //    return RedirectToAction("Dashboard", "Outdoor");
                    //}
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                ViewBag.ErrorMessage = "Please contact support on info@defendishair.com";
        ...
        private async Task<IActionResult> SendMail(string getEmail, string confirmationLink)
        {
            try
            {
                ...
                {
                    await smtpClient.SendMailAsync(new MailMessage("info@defendishair.com.ng", getEmail, "Defendis Hair", "Thank you for patronising Defendis Hair, Please click or paste the link below in a browser to activate your account. " + confirmationLink + " . If you have any questions please send a mail to info@defendishair.com.ng for your enquiries. Regards Defendis Hair Ltd"));
